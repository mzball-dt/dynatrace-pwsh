<#
.SYNOPSIS
    Get information about the User Groups of a specific Dynatrace Managed Cluster
...
PARAM (
    ...
    # If you want the meaningful version of Environment IDs to be provided aswell
    [switch] $resolveTenantNames,
    # Include the Management zones assigned to each group
    [switch] $includeManagementZones,
